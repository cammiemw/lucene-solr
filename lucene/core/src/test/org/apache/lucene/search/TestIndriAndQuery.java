...
public class TestIndriAndQuery extends LuceneTestCase {
  ...
  public void setUp() throws Exception {
    ...
    // Query is "President Washington"
    {
      ...
      d1.add(newTextField("body", "President Washington was the first leader of the US", Field.Store.YES));
...

    {
      ...
      d2.add(newTextField("body", "The president is head of the executive branch of government", Field.Store.YES));
...

    {
      ...
      d3.add(newTextField("body", "George Washington was a general in the Revolutionary War", Field.Store.YES));
